...
public class Check
{
    ...
    /// </summary>
    public Func<string, string, bool> Validator { get; set; } = null!;
    ...
    public static readonly List<Check> Checks =
    [
        new()
        {
        ...
        new()
        {
            ...
            InfuriationLevel = InfuriationLevel.High,
            Validator = (un, pwd) =>
                ";p|:-p|:P|:‑)|:)|:-]|:]|:>|:-}|:}|:o))|:^)|=]|=)|:]|:->|:>|8-)|:-}|:}|:o)|:^)|=]|=)|:‑D|:D|B^D|:‑(|:(|:‑<|:<|:‑[|:[|:{|:(|;(|:'‑(|:'(|:=(|:'‑)|:')|:‑O|:O|:‑o|:o|:-0|>:O|>:3|;‑)|;)|;‑]|;^)|:‑P|:-/|:/|:‑.|>:|>:/|:|:‑||>:‑)|>:)|}:‑)|>;‑)|>;)|>:3|;‑)|:‑J|<:‑||~:>/"
                    .Split('|').Any(pwd.Contains)
        },
